...
def main(in_args):
    ...
    dic_agent_conf_extra = {
        "WITH_EXTERNAL_API": in_args.with_external_api,
    ...
    dic_traffic_env_conf_extra = {
        ...
        "MODEL_NAME": f"{in_args.model}-{dic_agent_conf_extra['LLM_MODEL']}-open_llm",
        "PROJECT_NAME": in_args.proj_name,
        "LLM_API_THREAD_NUM": in_args.llm_api_thread_num,
        "RUN_COUNTS": count,
        "NUM_ROW": NUM_ROW,
        "NUM_COL": NUM_COL,
