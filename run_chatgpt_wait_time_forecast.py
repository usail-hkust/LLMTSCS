...
def parse_args():
    ...
    parser.add_argument("-memo", type=str, default='ChatGPTTLCSWaitTimeForecast')
    parser.add_argument("-model", type=str, default="ChatGPTTLCSWaitTimeForecast")
    ...
    parser.add_argument("-traffic_file", type=str, default="anon_3_4_jinan_synthetic_4000_10min.json")
