...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='ChatGPTTLCSCommonsenseNoCalculation')
    parser.add_argument("--model", type=str, default="ChatGPTTLCSCommonsenseNoCalculation")
