...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='ChatGPTTLCSCommonsenseFlowCoordination')
    parser.add_argument("--model", type=str, default="ChatGPTTLCSCommonsenseFlowCoordination")
